function printStats() {
   ...
   var press_eval_height_tolerance = document.getElementById("height-tolerance").value;
   var press_Eval_force_tolerance = document.getElementById("force-tolerance").value;
   ...
   if (pressName == "") {
      ...
      mywindow.document.write(
         "<br><div  style='background-Color:#252544 !important; padding: 2rem 0; height:400px;'><img  style='height:100%; width:90%; filter: saturate(8);'src='" +
            canvas_img_force +
            "'/></div>"
      );
      ...
      mywindow.document.write(
         "<br><div ' style='background-Color:#252544 !important; height:400px;'><img  style='height:100%; width:90%; filter: saturate(8);'src='" +
            canvas_img_height +
            "'/></div>"
      );
