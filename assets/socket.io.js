   ...
   return (function (t) {
      ...
      function (t, e, n) {
         function r(t, e) {
            ...
            return (
               f ? (a("ignoring socket cache for %s", i), (n = s(i, e))) : (c[u] || (a("new io instance for %s", i), (c[u] = s(i, e))), (n = c[u])),
               ...
               if ("string" == typeof t)
                  (n = c(t)),
                     e.BINARY_EVENT === n.type || e.BINARY_ACK === n.type
                        ? ((this.reconstructor = new p(n)), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", n))
                        : this.emit("decoded", n);
               else {
      ...
      function (t, e, n) {
         (function (r) {
            ...
            function s() {
               return (
                  "object" === ("undefined" == typeof console ? "undefined" : p(console)) && console.log && Function.prototype.apply.call(console.log, console, arguments)
               );
            }
            function a(t) {
               try {
                  ...
                  var n = setTimeout(function () {
                     t.skipReconnect ||
                        ...
                        t.skipReconnect ||
                           t.open(function (e) {
                              e
                                 ? (p("reconnect attempt error"), (t.reconnecting = !1), t.reconnect(), t.emitAll("reconnect_error", e.data))
         ...
         function r(t, e) {
            return this instanceof r
               ? ((e = e || {}),
                 ...
                 t
                    ? ((t = p(t)), (e.hostname = t.host), (e.secure = "https" === t.protocol || "wss" === t.protocol), (e.port = t.port), t.query && (e.query = t.query))
                        ...
                        : (e.onreadystatechange = function () {
                             if (2 === e.readyState)
                                try {
                                   ...
                                   ((n.supportsBinary && "application/octet-stream" === t) || "application/octet-stream; charset=UTF-8" === t) &&
      ...
      function (t, e) {
         function n(t) {
            for (var e, n, r = [], o = 0, i = t.length; o < i; )
               (e = t.charCodeAt(o++)),
                  e >= 55296 && e <= 56319 && o < i
                     ? ((n = t.charCodeAt(o++)), 56320 == (64512 & n) ? r.push(((1023 & e) << 10) + (1023 & n) + 65536) : (r.push(e), o--))
                     : r.push(e);
            return r;
         }
         function r(t) {
